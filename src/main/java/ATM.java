...
public class ATM {
    ...
    public static void main(String[] args){
        // init scanner
         ...
         // init bank
         Bank theBank = new Bank("Bank of Hein");

         //add a user, which also creates a savings account
         User aUser = theBank.addUser("John", "Doe", "1234");

         // add a checking account for our user
         Account newAccount = new Account("Checkking", aUser, theBank);
    ...
    public static User mainMenuPrompt(Bank theBank, Scanner sc){
        ...
        // prompts the user for user ID/pin combo until a correct one is reached
        do {
    ...
    public static void printUserMenu(User theUser, Scanner sc){
        ...
        // redisokay this menu unless the user wants to quit
        if(choice != 5) {
    ...
    public static void transferFunds(User theUser, Scanner sc){
        ...
        do {
            System.out.printf("Enter tje number (1-%d) of the account\n" + "to transfer from: ", theUser.numAccounts());
        ...
        do {
            ...
            if(amount < 0){
                ...
                System.out.printf("Amount must not be greather than\n" + "balance of $%.02f.\n", acctBal);
            }
     ...
     * @param theUser the logged-in User object
     * @param sc the Scanner object for user inout
     */
